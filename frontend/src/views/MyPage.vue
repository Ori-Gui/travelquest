<template>
  ...
  <div v-if="userReady" class="my-page-container">
    ...
    <section class="profile-section">
      <div class="avatar">
        <img :src="profile?.profileImageUrl || defaultAvatar" alt="Avatar" />
      </div>
...
// 탐험가 칭호 및 경험치 바
const explorerTitle = computed(() => titles[Number(rawUser.id) % titles.length]);
